...
df_spliceai_splicemap_ref_psi['Chromosome'] = df_spliceai_splicemap_ref_psi['variant'].str.split(':').str[0]
df_spliceai_splicemap_ref_psi.to_parquet(snakemake.output['spliceai_splicemap_ref_psi'], index=False, partition_cols=['Chromosome'])