...
if 'absplice_dna_custom_old' in config['models']:
    rule gene_level_absplice_dna_custom_old__tissue_subset:
        input:
...
if 'absplice_dna_custom_new' in config['models']:
    rule gene_level_absplice_dna_custom_new__tissue_subset:
        input:
...
if 'absplice_dna_custom_new' in config['models']:
    list_outputs.append(
        expand(rules.gene_level_absplice_dna_custom_new__tissue_subset.output, 
        vcf_id=wildcard_vcf_id, tissue_pred=config['tissues_subset']), # AbSplice-DNA
    )
if 'absplice_dna_custom_old' in config['models']:
    list_outputs.append(
        expand(rules.gene_level_absplice_dna_custom_old__tissue_subset.output, 
        vcf_id=wildcard_vcf_id, tissue_pred=config['tissues_subset']), # AbSplice-DNA
    )
