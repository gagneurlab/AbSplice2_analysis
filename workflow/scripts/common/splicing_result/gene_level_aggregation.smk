...
if 'absplice_dna_custom_old' in config['models']:
    rule gene_level_absplice_dna_custom_old:
        input:
...
if 'absplice_dna_custom_new' in config['models']:
    rule gene_level_absplice_dna_custom_new:
        input:
...
if 'pangolin' in config['models']:
    list_outputs.append(
        expand(rules.gene_level_pangolin.output, 
        vcf_id=wildcard_vcf_id), # Pangolin
    )
...
if 'absplice_dna_custom_old' in config['models']:
    list_outputs.append(
        expand(rules.gene_level_absplice_dna_custom_old.output, 
        vcf_id=wildcard_vcf_id), # AbSplice-DNA
    )
if 'absplice_dna_custom_new' in config['models']:
    list_outputs.append(
        expand(rules.gene_level_absplice_dna_custom_new.output, 
        vcf_id=wildcard_vcf_id), # AbSplice-DNA
    )
